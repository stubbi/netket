...
#ifndef NQS_PY_METROPOLISHAMILTONIANPT_HPP
#define NQS_PY_METROPOLISHAMILTONIANPT_HPP
      ...
      .def(py::init<AbstractMachine &, AbstractOperator &, int>(),
           ...
           py::arg("hamiltonian"), py::arg("n_replicas"), R"EOF(
             ...
             Examples:
                 ...
                 >>> sa = nqs.sampler.MetropolisHamiltonianPt(machine=ma,hamiltonian=ha,n_replicas=10)
