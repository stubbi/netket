...
def lanczos_ed(
    ...
    Examples:
        ...
        ...     nqs.graph.Hypercube(length=8, n_dim=1, pbc=True), s=0.5)
        >>> hamiltonian = nqs.operator.Ising(h=1.0, hilbert=hilbert)
        >>> r = nqs.exact.lanczos_ed(
...
def ImagTimePropagation(*args, **kwargs):
    ...
    Deprecated (nqs 2.0): Use `ExactTimePropagation` directly.
    """
