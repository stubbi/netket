...
number_of_sample_steps = [1,3,5,7,9,11,13,15,17]#[q if q%2 != 0 else q+1 for q in number_of_qubits] #[9,11,13]#[3,5,7] #size must be multiple of qubits (n*size), each n entries will be used for corresponding qubits
