...
number_of_circuits = 100 #number of random circuits with same number of qubits and cycles
...
number_of_training_samples = [samples(n), samples(n**2), samples(n**3), samples(2**n), samples(0.99 * 2**n), samples(0.98 * 2**n), samples(0.97 * 2**n), samples(0.96 * 2**n), samples(0.95* 2**n), samples(0.9 * 2**n), samples(0.85 * 2**n), samples(0.8 * 2**n)] 
