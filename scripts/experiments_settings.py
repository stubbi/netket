experiment_name = 'rcs-more'
circuit_generator_script = 'random_circuit.py'
# parameters to be tested
number_of_qubits = [12,14,16]
number_of_cycles = [12,14,16]
...
number_of_sample_steps = [0,5,9,15]#[q if q%2 != 0 else q+1 for q in number_of_qubits]
