...
number_of_qubits = range(2,26)
number_of_cycles = range(10,40)
...
number_of_training_samples = [100 + i * 100 for i in range(50)] 
number_of_training_iterations = [10000 + i * 10000 for i in range(50)]
