experiment_name = 'learn-debug-range'
circuit_generator_script = 'random_circuit.py'
# parameters to be tested
number_of_qubits = [2,4,6,8]
number_of_cycles = [2,4,6,8]
...
number_of_sample_steps = [0,0,0,0] #[q if q%2 != 0 else q+1 for q in number_of_qubits]
