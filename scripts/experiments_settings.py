...
number_of_qubits = [4,6]
number_of_cycles = [4,6]
...
number_of_training_samples = [100 + i * 200 for i in range(2)] 
number_of_training_iterations = [10000 + i * 20000 for i in range(2)]
