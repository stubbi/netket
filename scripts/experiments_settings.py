experiment_name = 'learn-debug-after-each-gate-2'
...
number_of_training_samples = [50]# + i * 400 for i in range(3)] 
number_of_training_iterations = [50]# + i * 40000 for i in range(3)]
