...
number_of_qubits = [3,5,7]#range(3,20,2)
number_of_cycles = [3,5,7] #[10]
...
number_of_training_samples = [1000]#[100 + i * 200 for i in range(5)] 
number_of_training_iterations = [10000]#[10000 + i * 20000 for i in range(5)]
